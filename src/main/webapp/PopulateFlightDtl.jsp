...
<body>
	<script language="Javascript">
		function CheckDate() {
			var populateStartDate = document
					.getElementById("populateStartDate").value;
			var ToDate = new Date();
			var populateStartDt = new Date(populateStartDate);
			if (populateStartDt.setHours(0, 0, 0, 0) < ToDate.setHours(0, 0, 0,
					0)) {
	...
	<div class="container col-md-8 col-md-offset-3" style="overflow: auto">
		<form action="flightSchedule/populateFlightDtl" method="post"
			onsubmit="return validateCount()">
			<h3>Flight Detail Population by date</h3>
			<div class="form-group">
				<label for="DayCount">Enter No. Of Days:</label> <input type="text"
					class="form-control" id="DayCount" name="DayCount" required>
			</div>
			<div class="form-group">
				<label for="populateStartDate">Enter Start Date</label> <input
					type="date" class="form-control" id="populateStartDate"
